...
class BidirectionalFoodSearchProblem:
    ...
    def getGoalStates(self):
        ...
        return parseGoalLocation(self.foodGrid)
...
def bidirectionalFoodProblemHeuristic(state, problem):
    ...
    value = 0
    for goal in parseGoalLocation(problem.foodGrid):
        value = value + util.manhattanDistance(state, goal)
    return value
